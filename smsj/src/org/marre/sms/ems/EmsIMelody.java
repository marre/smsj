 ...
 */
public class EmsIMelody extends SmsConcatMessage {
	...
	{		
		setContent(
				new SmsUdhElement[] {
						SmsUdhUtil.getEmsUserDefinedSoundUdh(theRingTone, 0)
				},
				"\n".getBytes(),
				1); // \n due to mBlox bug 
	}
	...
	private byte[] getImelodyBody(byte[] data) 
	{
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (isData) {
				temp = temp.substring(7); // remove the MELODY: part from the string				
	...
	private SmsPdu[] createEmsPdus()
	{
			...
			byte[] rtBody = this.getImelodyBody(data);
	...
	public static void main(String[] args) 
	{
		...
		data = "BEGIN:IMELODY\r\n";
		data += "VERSION:1.2\r\n";
		data += "FORMAT:CLASS1.0\r\n";
		data += "MELODY:*3f3f3f3#c1#d3#d3#d3c1r3f3f3f3#c3#f3#f3#f3f3*4#c3#c3#c3*3#a1*3f3f3f3#c1#d3#d3#d3c1r3f3f3f3#c3#f3#f3#f3f3*4#c3#c3#c3*3#a1\r\n";
		data += "END:IMELODY\r\n";

		//String data = "";
