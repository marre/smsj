 ...
 *
 * $Log$
 * Revision 1.2  2004/11/02 17:59:49  c95men
 * Major restructuring.
 *
...
public class EmsUdhElement extends SmsUdhElement
{
     ...
     * <p>
     * The length is including the UDH data length and the UDH "header" and
     * element position (2 bytes)
     * 
     * @return the length
     */
    ...
    /**
     * Return the UDH element including the UDH "header" and position.
     * 
     * @return Data
     */
    public byte[] getData()
